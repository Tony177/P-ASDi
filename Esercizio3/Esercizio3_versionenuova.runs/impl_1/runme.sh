...
HD_PWD='C:/Users/super/Desktop/magistrale/architetture/Esercizio3_versionenuova/Esercizio3_versionenuova.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riconoscitore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riconoscitore.tcl -notrace

...
HD_PWD='C:/Users/super/Desktop/magistrale/architetture/progettiVHDL/P-ASDi/Esercizio2/project_encoderBCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_completo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_completo.tcl -notrace

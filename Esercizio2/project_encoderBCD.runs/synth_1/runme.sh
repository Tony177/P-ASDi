...
HD_PWD='C:/Users/super/Desktop/magistrale/architetture/progettiVHDL/P-ASDi/Esercizio2/project_encoderBCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_completo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_completo.tcl
